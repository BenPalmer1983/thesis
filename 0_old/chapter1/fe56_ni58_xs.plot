...
# set output "plot.eps"
set terminal postscript eps monochrome enhanced blacktext  size 6.4,2.8
set output "fe56_ni58_xs.eps"
#
...
# Grid settings
#============================================
set grid xtics back lt 1 lw 0.5 
set grid ytics back lt 1 lw 0.5 
#set grid mxtics back lt 1 lw 1
#set grid mytics back lt 1 lw 1 
#
# Axes
#============================================
...
# Plot 1
#------------------
set title "TENDL Fe56 Reaction Cross Sections"
...
set key box opaque
plot \
'fe56_n_xs.csv' using 1:2 with lines axes x1y1 title "Neutron", \
'fe56_p_xs.csv' using 1:2 with lines axes x1y1 title "Proton", \
'fe56_d_xs.csv' using 1:2 with lines axes x1y1 title "Deuteron"
