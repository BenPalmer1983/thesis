...
\newglossaryentry{diagonalization}
{
...
\newacronym{pept}{PEPT}{Positron Emission Particle Tracking}
...
\newacronym{eampa}{EAMPA}{Embedded Atom Method Potential Analyser}
\newacronym{pwscf}{PWscf}{Plane-Wave Self-Consistent Field}
\newacronym{vasp}{VASP}{Vienna Ab initio Simulation Package}
\newacronym{gulp}{GULP}{General Utility Lattice Program}
...
\newacronym{fispact}{FISPACT}{FISPACT}
\newacronym{fati}{FATI}{Fusion Activation Transport Interface}
