...
\chapter[Austenitic Steels \& Nuclear Power]{Background: Austenitic Steels and Nuclear Power}
...
\centering
    \includegraphics[width=.9\linewidth]{chapters/background_austenitic_steels_in_nuclear/plots/fecrschaeffler.png}
    \caption{Steel Cr-Ni Schaeffler Diagram}
    \label{fig:FeCrNiSchaeffler}
\end{minipage}
\begin{minipage}{.46\textwidth}
\centering
  \includegraphics[width=.9\linewidth]{chapters/background_austenitic_steels_in_nuclear/plots/FeCrNi}
...
\begin{minipage}{.46\textwidth}
\centering
\includegraphics[width=.9\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/marwickfecrniseg1.png}
...
\begin{minipage}{.46\textwidth}
\centering
\includegraphics[width=.9\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/marwickfecrniseg2.png}
...
%\begin{figure}[h]
%  \begin{center}
%    \includegraphics[width=.65\linewidth]{chapters/background_austenitic_steels_in_nuclear/plots/nicrfeseg.eps}
...
%\begin{figure}[h]
%  \begin{center}
%    \includegraphics[width=.65\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/crseg.png}
...
\begin{minipage}{.46\textwidth}
\centering
  \includegraphics[width=.9\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/alloy-sensitization.jpg}
...
\begin{minipage}{.46\textwidth}
\centering
  \includegraphics[width=.9\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/Intergranular-corrosion__figure2.jpg}
...
\includegraphics[width=.95\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/fe30crru.png}
\end{minipage}
\begin{minipage}{.44\textwidth}
\includegraphics[width=.95\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/fe40crru.png}
\end{minipage}
...
\centering
    \includegraphics[width=.99\linewidth]{chapters/background_austenitic_steels_in_nuclear/images/pgmfailure.png}
