...
# Plot 1
#------------------
set title "Sheng Al EAM Potential"
set key font ",9"
...
set yrange [-2:30]
plot \
'sheng_eam_al.csv' using 1:2 with lines axes x1y1 title "Pair function", \
'sheng_eam_al.csv' using 3:4 with lines axes x1y1 title "Density function", \
'sheng_eam_al.csv' using 5:6 with lines axes x2y2 title "Embedding functional"
#------------------
# Plot 2
#------------------
