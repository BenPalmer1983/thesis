...
set y2tics nomirror tc lt 2
plot \
'fe_32_nbnd.csv' using 1:2 with linespoints axes x1y1 title "Energy(Ry)", \
'fe_32_nbnd.csv' using 1:3 with linespoints axes x1y2 title "Force (Ry/Au)"
#------------------
# Plot 2
#------------------
plot \
'fe_32_nbnd.csv' using 1:4 with linespoints axes x1y1 title "Memory/MB", \
'fe_32_nbnd.csv' using 1:5 with linespoints axes x1y2 title "Walltime/s"
#------------------
# Plot 3
#------------------
#------------------
