...
set output "nbnd1_al_convergence.eps"
#
...
# Plot 1
#------------------
set title "Al 1 Atom nbnd Convergence"
...
set y2tics nomirror tc lt 2
plot \
'nbnd1_al_convercence.csv' using 1:2 with linespoints axes x1y1 title "Energy per Atom (eV)"
#------------------
# Plot 2
#------------------
